...
class AddObjectiveActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View?) {
        when (view?.id) {
            ...
            R.id.cancelButton -> startActivity(Intent(this, ObjectiveStartPageActivity::class.java))
            ...
            R.id.goalsButton -> startActivity(Intent(this, ObjectiveStartPageActivity::class.java))
...
private fun addObjective() {
    ...
    if (denumire.isNotEmpty() && sumaTotala != null && iconitaIndex in iconLabels.indices) {
